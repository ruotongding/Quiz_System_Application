...
<body>
  ...
  createTable();
	...
	else
	{
      ...
      $sql = "INSERT INTO Staff (username, forename, surname, password)
              VALUES ('$username', '$forename', '$surname', '$password')";
      $pdo->query($sql);
			header('location:http://127.0.0.1:99/cw2/loginstaff.php');
    }
...
function showRegisterForm()
{
    ...
    <a href="http://127.0.0.1:99/cw2/loginstaff.php">Just Login</a>
	</form>
